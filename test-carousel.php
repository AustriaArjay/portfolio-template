        ...
        <div class="nav__container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item"><a href="#maxicare">Maxicare Plans</a></li>
                    <li class="nav__item"><a href="#assurance">Assurance</a></li>
                    <li class="nav__item"><a href="#footer">Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <header id="home" class="home">
                                ...
                                <div class="swiper-user">
                                    ...
                                    <p>    
                                        <i class="fas fa-quote-left"></i> 
                                            Gabino helped me set up my insurance and investment plan. Now, 
        ...
        <section class="consultation" id="consultation">
                ...
                <div class="consultation-blog">
                    ...
                    <div class="blog">
                        <a target="_blank" href="https://www.facebook.com/gabinocunadafinancialadvisor">
                            <img src="resources/blog/facebook.png">
                            FACEBOOK
                        </a>
                        <p>Sample short description</p>
                    </div>
                    <div class="blog">
                        <a target="_blank" href="https://www.tiktok.com/@insurance_guyph">
                            <img src="resources/blog/tiktok.png">
                            TIKTOK
                        </a>
                        <p>Sample short description</p>
                    </div>
            ...
            <div class="consultation-link">
                <div>
                    <h3>Get a FREE Financial or Corporate Benefits Consultation today!</h3>
                    <a 
                        href="https://m.me/assetprotectph" 
                        target="blank" 
                        class="contact-link"
                    >
                        Send a Message
                ...
                <div>
                    ...
                    <h3>Fill out the form below to get a free assessment.</h3>        
                    <a 
                        href="#" 
                        target="_blank" 
                        class="contact-link"
                    ...
                    <h3>Serving individuals and businesses nationwide in the Philippines!</h3>  
            </div>
        </section>
